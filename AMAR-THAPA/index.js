...
// Naming Practice
// var _myName = "vinod";
// var 1myName = "thapa"; // NA as first char cannot be number
// var _1my__Name = "bahadur";
// var $myName = "thapa technical";
// var myNaem% = "thapa technical"; // NA because of % . only $ and _ allowed 
...
// console.log( 10 + "20"); //  10 converts to "10" = string concatenation
// 9 - "5" // "5" converts to 5 = arithmatic operation
// console.log( 9 - "5"); //bug
// "Java" + "Script"
// console.log( "Java "+ "Script");
// " " + " " // spaces operation does not show anything
// console.log( " " + 0); // 0 => this is in string format
// "vinod" - "thapa" // NAN
// true + true // 2    // true = 1 , false = 0 (implicit conversion)
// true + false // 1
// false + true // 1 
// false - true // -1  
...
// var iAmUseless = null; // type of null is object = > bug . null should not be an object as it has no value.It is nothing.
...
// (either literals(1, 2...) or variables) as their operands and 
...
// ==   => VALUE EQUALITY ===  =>VALUES + TYPE EQUALITY
...
// == checks value equality but === checks both value and data type equality
...
// 4️⃣ While Loop Statement - statment(s) executes later only when condition is checked.
...
// 5️⃣ Do-While Loop Statement - statment executes first , condition is checked later
...
// ➡ we can now use Dynamic Properties 
  ...
  // console.log(myBio); // {myName:'vinod thapa',myAge:26}
...
// const sPerson = { ...person }; // copying object
...
// Nullish Coalescing operator (??) => checks null . if null then do something..
...
// x = 3.14; 
// console.log(x); // error as we have not defined let or const or var.we get this error only in strict mode . without strict mode , it is allowable in JS.
...
// After ES6 we have for..in and for..of loop too .for..in is for index iteration , for ..of is for value iteration
...
// Array.prototype.forEach() 🙋‍♂️ // we cant use break inside foreach.
...
// console.log(myFriendNames.indexOf("Thapa", 3)); // 3 starting index where search begins 
...
// returns length of the array after the push operation.
...
// Array.prototype.splice(par1,par2,par3) 🙋‍♂️ 
// par1 = position at which data is added
// par2 = delete count based on the position par1
// par3 = element to be added
...
// sol2:
// console.log(newMonth); // splice() returns delete count element(s) in an array.
...
// if(indexOfMonth != -1){
//   const updateMonth = months.splice(indexOfMonth,2); // instead of 2 use infinity.It will delete all elements from the indexOfMonth position onwards.
//   console.log(months);
...
//   return `Index no = ${index} and the value is ${curElm} belong to ${arr} `
// })
// console.log(newArrfor); // undefined as array1 is updated, not newArrfor.

// map returns new array without mutating the orignal array.foreach mutates the original array.soes not return anything.
// we can perform method chaining with map() , not the case with foreach()
...
// 👉 Reduce Method => returns a scalar value after performing operations in an array.
...
// Accumulator => accumulates value after every iteration , default starting value for number is 0 for acc.
// Current Value
// Current Index
// Source Array
...
//         debugger;
//       return accumulator += curElem;
// },7) // acc value from the beginning is 7
// console.log(sum);
...
// console.log(myBioData.indexOf("t", 6)); // 6th index -->
...
// const myBioData =  'I am the thapa Technical';
// console.log(myBioData.lastIndexOf("t", 6)); // <--6th index
...
// and the end position (exclusive and optional).
...
//  counted from the 0th pos and end index will be exclusive .
...
// search online on Join() = opposite of split()
...
// In browser actual date time is printed but in VS Code terminal some of date and time will come in milliseconds.
...
// Section 10👉 Document Object model in JavaScript - check online for notes
...
// ************** DOM vs BOM ******************* check online for notes
...
// We will see the new file .geteElementByID,queryselector('. => class , # => ID')=> returns first found element ,querySelectorall('. => class , # => ID') returns total count of found elements and names , classname , tagName , Names and all ... check session
...
/**** Section 11👉 EVENTS in JavaScript - check online for notes ****/ 
...
// check the Events HTML File from git repo or check online session - 9.50 >>
...
// 👉  JavaScript Timing Events - check online for notes
...
// The definition  of "this" object is that it contain the current context/instance. 
...
// // ex 2 
// function myName() {
//     console.log(this); // window is the current instance
// }
// myName();
...
//     myAge : 26,
//     myName() {
//       console.log(this); // // current instace or object i.e. obj
//     }
// }
// obj.myName();
...
//     myAge : 26,
//     myName : () => {
//       console.log(this); // this does not work with arrow fn.window obj.
//     }
// }
// obj.myName();
...
// event.target is the element which fires the event.
  
// // 1️⃣: Event Propagation (Event Bubbling and Event Capturing)

// // check html file.Check ppt slides and search online and make notes.
...
// // 🏁🏁Asynchronous JavaScript - multiple work at a time . Parallel works.


// // 6️⃣:   Synchronous JavaScript Prog - one work at a time 
...
//   return innerFun;
// }
// let checkClousure = outerFun(5); // holds inner function having a closure of outer function and its scope variabls and paramenters
...
// let x = "vinod"; // no error as let or var or const is used.
// console.log(x);
...
// Currying - The process of transforming a function that takes multiple arguments into a function that takes just a single argument and returns another function if any arguments are still needed is called currying a function.

// Currying - with normal functions
...
// const res1 = sum(1)
// const res2 = res1(2) // sum(1)(2)
// const res3 = res2(3) // susm(1)(2)(3)
...
// // 8️⃣: CallBack Hell . callback insides callback inside callback and so on creates a pyramid of doom called callback hell.To resolve this problem we have promises.
...
// // 7️⃣ AJAX Call using XMLHttprequest  - search online - refer notes and video in sync.

// // how to handl with the events and callback 
